...
import Banner from "../../../public/banners/appBanner.png";
import Calendar from "../../../public/banners/cal.png";
  ...
  return (
    <>
      ...
      >
        <TitleSection
          pill="🚀 Launch"
          title="Launch your next big idea with ideaFlow"
        />
        <div
          className="
          bg-white
        ...
        <div
          ...
          ml-[-50px]"
        >
          <Image src={Banner} alt="ideaFlow Banner" />
          <div
            className="
            bottom-0
            top-[50%]
